...
import {INVALID_AVATAR} from "src/models/user/errors";
import {INVALID_USERNAME} from "src/models/user/errors";
import {INVALID_PASSWORD} from "src/models/user/errors";
import {INVALID_INITIALS} from "src/models/user/errors";
import {INVALID_LASTNAME} from "src/models/user/errors";
import {INVALID_FIRSTNAME} from "src/models/user/errors";
