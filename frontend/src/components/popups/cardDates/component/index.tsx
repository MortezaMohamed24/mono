...
import * as DATE_TIME from "/popups/dateTime";
  ...
  return (
    <>
      ...
      <section className={`${ps.body} ${s.body}`}>
        {card ? (
          <>
            ...
            <div>
              <h3 className={type.caption}>Due date</h3>
      ...
      <footer className={ps.footer}>
        <p className={type.sm}>The date format used to display dates is yyyy/mm/dd hh:mm</p>
      </footer>
    </>
  );
});
