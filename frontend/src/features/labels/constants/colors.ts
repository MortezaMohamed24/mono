...
export const YELLOW = Object.freeze({id: v4(), name: "yellow", value: "#f1c40f"} as const);
...
export const ALL = Object.freeze([RED, SKY, BLUE, CYAN, PINK, DARK, LIME, GREEN, INDIGO, ORANGE, PURPLE, YELLOW]);
