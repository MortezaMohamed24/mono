...
export const BLUE = Object.freeze({id: v4(), name: "blue", value: "#4424d6"} as const);
...
export const INDIGO = Object.freeze({id: v4(), name: "indigo", value: "#00477e"} as const);
...
export const ALL = Object.freeze([RED, SKY, BLUE, CYAN, LIME, DARK, PINK, GREEN, INDIGO, ORANGE, PURPLE]);
export const NAMES = Object.freeze(ALL.map(theme => theme.name));
export const VALUES = Object.freeze(ALL.map(theme => theme.value));
