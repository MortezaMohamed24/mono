...
import formatAsChecklistRawNested from "/features/checklists/entity/rawNested";
...
export const formatAsCardRawNested = OBJECT({
  id: OID(),
  title: title,
  dateDue: dateDue,
  idLabels: ARRAY([OID()]),
...
export default formatAsCardRawNested;